...
<html>
  ...
  <div class="row center">
    <h1>HACK ET CULTURE DU LIBRE :</h1>
    <h2>C'est quoi un hacker ?</h2>
   
<p>Un hacker sur internet c’est quelqu’un qui va trouver des failles, des endroits ou il y a une erreur pour pouvoir accéder au code dont il n’a pas accès normalement et le modifier. Il y a différents types de hacker : hacker malveillant (black-hat),  bienveillant (white-hat)et les hackers curieux (grey hat).
<p>
  <div class="row center">
  <img src="hacker.jpg" class="" alt="">
  <p> On a souvent cette image du hacker </p>
  <img src="munchbidouille.jpg" class="" alt="">
  <p>Mais un hacker ca peut être ça aussi ! </p>
  </div>

  <div class="row center">
    <a class="button" href="16.php">suivant</a>
  </div>
